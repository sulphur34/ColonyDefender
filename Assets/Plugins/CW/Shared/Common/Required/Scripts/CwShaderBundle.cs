...
namespace CW.Common
{
    ...
    public class CwShaderBundle : ScriptableObject
    {
        ...
        { set { projectHash = value; } get { return projectHash; } }
        ...
        { get { if (variants == null) variants = new List<ShaderVariant>(); return variants; } }
